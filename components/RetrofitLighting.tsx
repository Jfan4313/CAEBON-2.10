...
const RetrofitLighting: React.FC = () => {
  const [strategy, setStrategy] = useState<'led' | 'smart'>('smart');
                ...
                <section className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <label className={`cursor-pointer group relative p-4 rounded-lg border-2 transition-all h-full shadow-sm flex flex-col ${strategy === 'smart' ? 'border-primary bg-primary/5 ring-1 ring-primary/20' : 'border-slate-200 hover:border-primary/50'}`}>
                            ...
                            <h4 className="font-bold text-slate-900 mb-1">智能感应控制</h4>
                            <p className="text-xs text-slate-500 leading-relaxed">加装人体感应、照度感应与时间控制，实现人来灯亮、人走灯灭及恒照度控制。</p>
                        </label>
                    </div>
                </section>
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-4 bg-slate-50/50">
              <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                  ...
                  <div className="flex items-baseline gap-2">
                      <span className="text-3xl font-bold text-slate-900 tracking-tight">158,400</span>
                      <span className="text-sm text-slate-500">kWh</span>
                  </div>
                  <div className="mt-2 text-xs font-medium text-green-600 flex items-center">
                      <span className="material-icons text-sm mr-0.5">trending_down</span> 60.5% 同比下降
                  </div>
              </div>
               ...
               <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                  ...
                  <div className="flex items-baseline gap-2">
                      <span className="text-3xl font-bold text-slate-900 tracking-tight">¥ 13.2</span>
...
export default RetrofitLighting;