...
const RetrofitWater: React.FC = () => {
  const [strategy, setStrategy] = useState<'heatpump' | 'solar'>('heatpump');
                ...
                <section className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <label className={`cursor-pointer group relative p-4 rounded-lg border-2 transition-all h-full shadow-sm flex flex-col ${strategy === 'solar' ? 'border-primary bg-primary/5 ring-1 ring-primary/20' : 'border-slate-200 hover:border-primary/50'}`}>
                            ...
                            <h4 className="font-bold text-slate-900 mb-1">太阳能/余热回收</h4>
                            <p className="text-xs text-slate-500 leading-relaxed">利用太阳能集热器或空压机余热制取热水，实现零碳加热。</p>
                        </label>
                    </div>
                </section>
        ...
        <div className="fixed bottom-0 left-64 right-0 bg-white/95 backdrop-blur-md border-t border-slate-200 p-4 px-8 z-40 flex items-center justify-between shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
            <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                    ...
                    <span className="text-[10px] text-slate-400 font-medium">5天前</span>
                </div>
            </div>
            <div className="flex items-center gap-3">
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-4 bg-slate-50/50">
              <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                  <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs font-semibold text-slate-500 uppercase">年节能量 (折算电)</span>
                  </div>
                  <div className="flex items-baseline gap-2">
                      <span className="text-3xl font-bold text-slate-900 tracking-tight">215,000</span>
               ...
               <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                  ...
                  <div className="flex items-baseline gap-2">
                      <span className="text-3xl font-bold text-slate-900 tracking-tight">¥ 18.8</span>
               ...
               <div className="bg-primary p-4 rounded-xl shadow-lg shadow-primary/20 text-white relative overflow-hidden">
                   ...
                   <div className="flex items-baseline gap-2 relative z-10">
                       <span className="text-3xl font-bold tracking-tight">¥ 85.0</span>
