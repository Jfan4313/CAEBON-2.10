...
export default function RetrofitWater() {
  ...
  const simulation = useMemo(() => {
      ...
      const yearlySaving = annualBaselineCost - annualRetrofitCost;
      const savingRate = annualBaselineCost > 0 ? (yearlySaving / annualBaselineCost) : 0;
      const payback = yearlySaving > 0 ? investment / yearlySaving : 0;
      ...
      for(let i=0; i<10; i++) cashFlows.push(yearlySaving);
  ...
  useEffect(() => {
      if (
          currentModule.investment !== simulation.investment ||
          currentModule.yearlySaving !== simulation.yearlySaving
      ) {
          updateModule('retrofit-water', {
              ...
              params: { mode, params, strategy }
          });
      }
  }, [simulation, params, strategy, mode, updateModule, currentModule]);
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-4 bg-slate-50/50">
              ...
              <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
               ...
               <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                  ...
                  <div className="flex items-baseline gap-2">
                      <span className="text-3xl font-bold text-slate-900 tracking-tight">¥ {simulation.yearlySaving.toFixed(1)}</span>
